...
import { birthdaySchema, descriptionSchema, followedMessageSchema, locationSchema, prefectureSchema, nameSchema } from '@/models/User.js';
...
export const paramDef = {
	...
	properties: {
		...
		prefecture: { ...prefectureSchema, nullable: false },
...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(
		...
		super(meta, paramDef, async (ps, _user, token) => {
			...
			profileUpdates.prefecture = ps.prefecture;
