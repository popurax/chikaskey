...
import { MiUserProfile, type MiMeta, type NotesRepository } from '@/models/_.js';
...
export const meta = {
	...
	errors: {
		ltlDisabled: {
			message: 'Prefecture timeline has been disabled.',
			code: 'LTL_DISABLED',
...
export const paramDef = {
	...
	properties: {
		...
		prefecture: { type: 'string', enum: prefectures.filter(n => n !== '_empty') },
