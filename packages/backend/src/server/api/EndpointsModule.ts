...
import * as ep___notes_prefectureTimeline from './endpoints/notes/prefecture-timeline.js';
...
const $notes_prefectureTimeline: Provider = { provide: 'ep:notes/prefecture-timeline', useClass: ep___notes_prefectureTimeline.default };
